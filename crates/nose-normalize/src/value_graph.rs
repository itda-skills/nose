...
use nose_semantics::{
    ...
    admitted_rust_option_some_constructor_at_node, admitted_rust_vec_macro_factory_at_call_span,
    admitted_rust_vec_new_factory_at_call, admitted_scalar_integer_method_at_call,
