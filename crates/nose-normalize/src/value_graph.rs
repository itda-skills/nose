...
use nose_semantics::{
    ...
    admitted_java_collection_constructor_at_call, admitted_java_map_entry_at_call,
    admitted_java_map_factory_at_call, admitted_js_like_map_constructor_at_call,
    ...
    admitted_rust_option_some_constructor_at_call, admitted_rust_vec_new_factory_at_call,
    ...
    library_java_map_factory_contract_by_hash, library_map_get_contract_by_hash,
    ...
    library_rust_vec_macro_factory_contract, map_builder_index_write_contract,
