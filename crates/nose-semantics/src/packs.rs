...
use crate::{
    ...
    BUILTIN_METHOD_CALL_PROTOCOL_PRODUCER_ID, CSS_LANGUAGE_PACK_ID, C_LANGUAGE_PACK_ID,
    ...
    FREE_FUNCTION_BUILTIN_PROTOCOL_PRODUCER_ID, GO_LANGUAGE_PACK_ID,
    HTML_EMBEDDED_LANGUAGE_PACK_ID, ITERATOR_IDENTITY_ADAPTER_CONTRACT_ID,
    ITERATOR_IDENTITY_ADAPTER_PACK_ID, ITERATOR_IDENTITY_ADAPTER_PRODUCER_ID,
    JAVA_LANGUAGE_PACK_ID, JAVA_STDLIB_COLLECTION_CONSTRUCTOR_EMPTY_LIST_CONTRACT_ID,
    ...
    MAP_GET_CONTRACT_ID, MAP_GET_DEFAULT_CONTRACT_ID, MAP_GET_DEFAULT_PROTOCOL_PACK_ID,
    ...
    PYTHON_BUILTIN_COLLECTION_FACTORY_PRODUCER_ID, PYTHON_LANGUAGE_PACK_ID,
    ...
    RUBY_LANGUAGE_PACK_ID, RUBY_STDLIB_SET_CONTRACT_ID, RUBY_STDLIB_SET_PACK_ID,
    RUBY_STDLIB_SET_PRODUCER_ID, RUST_LANGUAGE_PACK_ID, RUST_STDLIB_COLLECTION_FACTORY_CONTRACT_ID,
    ...
    SCALAR_INTEGER_METHOD_MIN_CONTRACT_ID, SWIFT_LANGUAGE_PACK_ID,
};
