...
use crate::{
    ...
    SCALAR_INTEGER_METHOD_MIN_CONTRACT_ID, SWIFT_LANGUAGE_CORE_PRODUCER_ID, SWIFT_LANGUAGE_PACK_ID,
    SWIFT_SOURCE_FACT_PRODUCER_ID, SWIFT_STDLIB_COLLECTION_FACTORY_PACK_ID,
