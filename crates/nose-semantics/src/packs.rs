...
use crate::{
    ...
    JAVA_STDLIB_MAP_FACTORY_PRODUCER_ID, JAVA_STDLIB_STATIC_COLLECTION_ADAPTER_CONTRACT_ID,
    JAVA_STDLIB_STATIC_COLLECTION_ADAPTER_PACK_ID,
    JAVA_STDLIB_STATIC_COLLECTION_ADAPTER_PRODUCER_ID, JS_LIKE_BUILTIN_PROMISE_PACK_ID,
    JS_LIKE_BUILTIN_PROMISE_PRODUCER_ID, JS_LIKE_BUILTIN_PROMISE_RESOLVE_CONTRACT_ID,
    JS_LIKE_BUILTIN_PROMISE_THEN_CONTRACT_ID, PYTHON_BUILTIN_COLLECTION_FACTORY_CONTRACT_ID,
