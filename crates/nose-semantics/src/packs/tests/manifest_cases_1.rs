...
fn local_manifest_loads_as_metadata_only_opt_in() {
    ...
    assert_eq!(set.packs()[27].id, MAP_GET_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[28].id, MAP_GET_DEFAULT_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[29].id, FREE_FUNCTION_BUILTIN_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[30].id, RECEIVER_MEMBERSHIP_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[31].id, MAP_KEY_VIEW_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[32].id, PROPERTY_BUILTIN_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[33].id, BUILTIN_METHOD_CALL_PROTOCOL_PACK_ID);
    assert_eq!(set.packs()[34].id, GO_STDLIB_NAMESPACE_CALL_PACK_ID);
    assert_eq!(set.packs()[35].id, ITERATOR_IDENTITY_ADAPTER_PACK_ID);
    assert_eq!(set.packs()[36].id, JS_LIKE_BUILTIN_PROMISE_PACK_ID);
    assert_eq!(set.packs()[37].id, JS_LIKE_BUILTIN_ARRAY_PACK_ID);
    assert_eq!(set.packs()[38].id, JS_LIKE_BUILTIN_BOOLEAN_PACK_ID);
    assert_eq!(set.packs()[39].id, JS_LIKE_BUILTIN_REGEX_PACK_ID);
    assert_eq!(
        set.packs()[40].id,
    ...
    assert_eq!(set.packs()[42].id, PYTHON_STDLIB_TYPE_DOMAIN_PACK_ID);
    assert_eq!(set.packs()[43].id, VALUE_GRAPH_LAW_PACK_ID);
    let external = &set.packs()[44];
