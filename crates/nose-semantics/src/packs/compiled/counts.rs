...
pub(super) fn python_stdlib_type_domain_conformance_refs() -> Vec<&'static str> {
...
pub(super) fn value_graph_law_ids() -> Vec<&'static str> {
...
pub(super) fn value_graph_law_conformance_refs() -> Vec<&'static str> {
...
pub(super) fn value_graph_law_counts() -> SemanticPackCounts {
