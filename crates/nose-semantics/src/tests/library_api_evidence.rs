...
fn js_like_builtin_boolean_record(
    id: u32,
    span: Span,
    contract_id: LibraryApiContractId,
    callee: LibraryApiCalleeContract,
...
fn js_like_builtin_regex_record(
    id: u32,
    span: Span,
    contract_id: LibraryApiContractId,
    callee: LibraryApiCalleeContract,
...
fn map_get_default_protocol_record(
    id: u32,
    span: Span,
...
fn receiver_membership_protocol_record(
    id: u32,
    span: Span,
    contract: LibraryMethodCallContract,
    status: EvidenceStatus,
...
fn builtin_method_call_protocol_record(
    id: u32,
    span: Span,
    contract: LibraryMethodCallContract,
    arity: u16,
