...
pub const JS_LIKE_BUILTIN_PROMISE_REJECT_CONTRACT_ID: &str = "js_like.promise.factory.reject";
pub const JS_LIKE_BUILTIN_PROMISE_THEN_CONTRACT_ID: &str = "js_like.promise.then";
pub const JS_LIKE_BUILTIN_PROMISE_CATCH_CONTRACT_ID: &str = "js_like.promise.catch";
pub const JS_LIKE_BUILTIN_PROMISE_FINALLY_CONTRACT_ID: &str = "js_like.promise.finally";
pub const JS_NODE_TIMERS_PROMISES_PACK_ID: &str = "nose.javascript.node.timers_promises";
pub const JS_NODE_TIMERS_PROMISES_PRODUCER_ID: &str = "javascript.node.timers-promises-api";
pub const JS_IMPORTED_PROMISE_FACTORY_CONTRACT_ID: &str = "js_like.imported.promise_factory";
...
pub const JS_LIKE_BUILTIN_ARRAY_HOF_CONTRACT_ID: &str = "js_like.array.hof.method_call";
pub const JS_LIKE_BUILTIN_ARRAY_BOOL_REDUCTION_CONTRACT_ID: &str =
    "js_like.array.bool_reduction.method_call";
...
pub const FREE_FUNCTION_HOF_CONTRACT_ID: &str = "free_function_hof.call";
pub const PYTHON_ITERATOR_BUILTIN_PROTOCOL_PACK_ID: &str = "nose.protocols.iterator_builtins";
pub const PYTHON_ITERATOR_BUILTIN_PROTOCOL_PRODUCER_ID: &str = "protocols.iterator-builtin-api";
pub const PYTHON_ITERATOR_BUILTIN_CONTRACT_ID: &str = "iterator_builtin.call";
