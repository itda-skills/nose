...
fn method_call_contract_provenance(
    ...
    if rust_sequence_hof_method_call(lang, contract)
        ...
        || csharp_sequence_hof_method_call(lang, contract)
    {
        (
...
mod receiver;
mod selectors;
pub(in crate::library_api) use classification::csharp_sequence_hof_method_call;
...
pub use promise::{
    library_imported_promise_factory_contract, library_imported_promise_factory_contracts,
    library_promise_aggregate_contract, library_promise_catch_contract,
    library_promise_finally_contract, library_promise_resolve_contract,
