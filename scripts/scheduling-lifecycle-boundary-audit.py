...
PATTERNS: tuple[Pattern, ...] = (
    ...
    Pattern("rust", "rust.async.join", "join/try_join", "success-error-result-channel", "async-aggregate-all-completion-contract-missing", "future all-completion aggregate", "join style macros need all-completion result-channel proof", re.compile(r"\b(?:(?:tokio|futures|futures_util)::)?(?:join|try_join)!\s*\(")),
    Pattern("rust", "rust.async.select", "select", "cancellation-liveness-boundary", "async-aggregate-first-completion-contract-missing", "future first-completion aggregate", "select style macros need first-completion, cancellation, and result-channel proof", re.compile(r"\b(?:(?:tokio|futures|futures_util)::)?select!\s*\(")),
