...
literal/wildcard/range/tuple/OR/guarded `match` arms lowering to an if-chain, or Python
literal/wildcard/capture/qualified/sequence/OR/guarded `match` cases lowering to an if-chain, or Go
