...
- [query-json](query-json.md) — the versioned `nose query --format json` contract (schema v7): the structured, view-shaped machine form of the exploration surface.
...
- [scheduling-channel-callback-obligations-594](scheduling-channel-callback-obligations-594.md) — issue #594's cross-language obligation vocabulary, Promise/scheduling closeout, and census-backed guardrails for scheduling, error/rejection channels, callback demand/effect, lifecycle, and mutation boundaries.
