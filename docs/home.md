...
- [scheduling-channel-callback-obligations-594](scheduling-channel-callback-obligations-594.md) — issue #594's cross-language obligation vocabulary, Promise/scheduling closeout, and #602 census-backed guardrails plus exact Promise aggregate slices and reporting-only executor and AbortSignal cancellation readiness slices for scheduling, aggregate, cancellation, error/rejection channels, callback demand/effect, lifecycle, and mutation boundaries.
