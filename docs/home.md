...
- [scheduling-channel-callback-obligations-594](scheduling-channel-callback-obligations-594.md) — issue #594's cross-language obligation vocabulary and census-backed guardrails for scheduling, error/rejection channels, callback demand/effect, lifecycle, and mutation boundaries.
