...
| `SequenceSurface` | lowered aggregate surface such as collection, tuple, map, pair, record guard, own-property guard, Go map literal/entry, or Rust struct expression |
